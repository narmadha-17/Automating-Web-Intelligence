    ...
    return (
        <div style={{
            ...
            {isLongResult && (
                ...
                >
                    {isExpanded ? 'Gåæ Collapse' : 'Gåô Expand'}
                </button>
            )}
        </div>
    );
        ...
        <>
            ...
            <div style={nodeStyles}>
                ...
                <div style={titleStyle}>
                    <span style={{ fontSize: '1.5rem' }}>=ƒöì</span>
                ...
                <div style={statusStyle(data.status)}>
                    <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        {data.status === 'running' && <span className="animate-spin">Gî¢</span>}
    ...
    return (
        <>
            ...
            <div style={nodeStyles}>
                ...
                <div style={titleStyle}>
                    <span style={{ fontSize: '1.5rem' }}>=ƒò+n+Å</span>
    ...
    return (
        <>
            ...
            <div style={nodeStyles}>
                ...
                <div style={titleStyle}>
                    <span style={{ fontSize: '1.5rem' }}>=ƒù¦n+Å</span>
    ...
    return (
        <>
            ...
            <div style={nodeStyles}>
                ...
                <div style={titleStyle}>
                    <span style={{ fontSize: '1.5rem' }}>=ƒºá</span>
